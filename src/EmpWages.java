public class EmpWages {
    ...
    public EmpWages (String Company, int fullTimeHrs, int partTimeHrs, int WAGE_PER_HRS, int DAY_PER_MONTH, int MAX_HRS)
    {
    ...
    public static void main (String []args) {
        ...
        EmpWages PramukhCotex =new EmpWages("PramukhCotex",8,8,20,20,100);
